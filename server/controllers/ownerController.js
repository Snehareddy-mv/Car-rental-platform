...
//api to list car or to add car by owner
...
//api to list owner cars or list of cars a particular user have
...
export const getDashboardData = async (req, res) => {
  try {
    ...
    //calculate monthly revenue when booking status is confirmed
